function [ L dLdF ] = loss_hinge(F, Y, idx, loss_vec)
% Compute the objective function value and functional gradient for hinge loss,
% a.k.a. SVM loss, for the outputs in F and the (weighted) target classes in Y.
%
% Parameters:
