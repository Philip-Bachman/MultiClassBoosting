function [ X_train Y_train X_test Y_test ] = data_grid( obs_count, train_count, sigma_min, sigma_max, grid_width, class_centers )
...
X_train = X(1:train_count,:);
Y_train = Y(1:train_count);
X_test = X(train_count+1:end,:);
Y_test = Y(train_count+1:end);
